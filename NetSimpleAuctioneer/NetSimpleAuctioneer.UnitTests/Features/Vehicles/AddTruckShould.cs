...
namespace NetSimpleAuctioneer.UnitTests.Features.Vehicles
{
    public class AddTruckShould
    {
        ...
        {
            // Arrange
            var vehicle = fixture.Create<Truck>();
            var cancellationToken = CancellationToken.None;
        ...
        public async Task HandleShouldReturnSuccessWhenValidationsPass()
        {
            ...
            mockVehicleService.Setup(repo => repo.AddVehicleAsync(It.IsAny<Truck>(), cancellationToken))
                .ReturnsAsync(VoidOrError<AddVehicleErrorCode>.Success());

            var handler = new AddTruckHandler(mockVehicleService.Object);
        ...
        public void MapToEntityShouldMapSUVToVehicle()
        {
            ...
            vehicleEntity.LoadCapacity.Should().Be(suv.LoadCapacity);
        }
    }
}